...
<body>
    ...
    <!-- Hero Banner -->
    <header class="herobanner herobanner-down">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12 text-center">
                    <h1>Temporarily Unavailable</h1>
                    <p>Sorry this page is temporarily unavailable as it is currently under maintenance.<br>Thank you for your understanding.</p>
                </div>
            </div>
        </div>
    </header>
